...
\subsection{Databases}
  ...
  \begin{theorem}{CAP Theorem}
    The \textit{CAP Theorem}\foonote{Proved by Gilbert and Lynch in 2002.} states that a distributed system or database can guarantee at most two of the following three properties at any one time
    \begin{itemize}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.7\textwidth]{DataStorageFlowCharts.PNG}
